/*
 * Texture atlas maker. Based on Atlas Generator of Jacob Schieck - 2011 - http://www.jacobschieck.com
 * Usage 
 *      1. Open the window (Window/Atlas Maker).
...
public class AtlasMaker : EditorWindow
{
	...
	//[MenuItem("Window/MEAnimation/Atlas Maker %#m")]
	...
	void OnGUI ()
	{
		...
		directory = EditorGUILayout.ObjectField ("Textures Directory:", directory, typeof(UnityEngine.Object), false);
